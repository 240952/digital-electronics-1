        ...
        begin
            if Clk'event and Clk = '1' then
                case r_SM_Main is 
                    ...
                    -- s_data_valid                    nula do platnych dat
                    -- s_indexBitA                     nula do aktualniho indexu bitu
                    -- s_StartBit_rx;                  do stavu start
                    -- A_data = '0'                    aktualni hodnota signalu
                    -- s_ClkCount <=0;                 reset clkcount
                    -- s_ClkCount <= s_ClkCount +1;    inkrementace count
                    -- s_bytes(s_indexBitA) <= A_data; ulozeni prijeteho bitu
                    -- if s_indexBitA<7                zde kontroluju,zda jsem prijal vsechny bity
