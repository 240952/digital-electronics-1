...
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { TX_End_T }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { TX_A_T }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { syn }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
...
##USB-RS232 Interface
set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { TX_T }]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { RX_T }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { rx_dout }]; #IO_L12N_T1_MRCC_35 Sch=uart_cts
#set_property -dict { PACKAGE_PIN E5    IOSTANDARD LVCMOS33 } [get_ports { RESET_syn }]; #IO_L5N_T0_AD13N_35 Sch=uart_rts
